    ...
    subjects: [
      {
        ...
        description: "Fundamentos de hardware y software",
        hours: 170,
      },
      {
        name: "Bases de Datos",
      ...
      },
      {
        ...
        description: "HTML, CSS, XML y JSON",
        hours: 140,
      },
      {
        name: "Entornos de desarrollo",
        description: "IDEs y herramientas de desarrollo",
        hours: 90,
      },
      {
        name: "Formación y orientación laboral",
        description: "Preparación para el mundo laboral",
        hours: 90,
      },
    ],
  },
    ...
    subjects: [
      {
        ...
        description: "JavaScript y frameworks frontend",
        hours: 130,
      },
      {
        name: "Desarrollo web en entorno servidor",
        description: "PHP, Java o .NET para backend",
        hours: 170,
      },
      {
      ...
      },
      {
        ...
        description: "UX/UI y diseño responsivo",
        hours: 130,
      },
      {
        name: "Empresa e iniciativa emprendedora",
        description: "Fundamentos para crear tu propia empresa",
        hours: 65,
      },
      {
        name: "Inglés Técnico Superior",
        description:
          "Vocabulario y expresiones técnicas en inglés relacionadas con el desarrollo web y la programación.",
        hours: 40,
      },
      {
      ...
      },
      {
        ...
        description: "Prácticas en empresas",
        hours: 370,
      },
    ],
  },
          ...
          <div key={yearIndex} className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {year.subjects.map((module, index) => (
                ...
                >
                  <h4 className="text-xl font-semibold mb-2 text-blue-800 dark:text-blue-300">
                    {module.name}
                  </h4>
